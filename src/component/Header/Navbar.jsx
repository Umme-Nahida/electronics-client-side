...
const Navbar = () => {
  ...
  useEffect(()=>{
   ...
   setMode(currentMode)
    ...
    return (
        <div>
            <div className="max-w-[1350px] dark:bg-white mx-auto px-10 py-4 shadow-xl">
                <div className="flex items-center justify-between ">
                    ...
                    <div className=" hidden lg:block navbar-start">
                        <div className="flex justify-start items-center">
                            <img className="w-16 hidden lg:block" src="https://i.ibb.co/FnCMMMt/png-clipart-www-logo-computer-network-internet-material-network-technology-blue-electronics-removebg.png" alt="" />
                    ...
                    <div className="flex items-center gap-2 navbar-end">
                        ...
                        <div className="flex items-center justify-center">
                            ...
                            {
                                user ? <button onClick={handleSignOut} className="btn bg-[#5593DD] text-white ">Sign Out</button> :
                                    <Link to='/login'>
